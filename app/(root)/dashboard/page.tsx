    ...
    <>
      <div className='p-5 lg:px-20'>
        <div className='rounded-lg shadow-md shadow-black p-5 mb-5'>
          <h1 className='font-bold text-3xl lg:text-3xl text-center text-white'>{message}, {userName}</h1>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 mt-5 gap-5 rounded-md'>
          ...
          <div className='border border-black rounded-md grid grid-cols-1 gap-2 lg:gap-5 p-3 h-[440px] overflow-auto'>
            <h1 className='font-bold text-center text-2xl text-white'>Your Budgets</h1>
            {
